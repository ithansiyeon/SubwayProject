...
<table style="width:500px;">
    ...
    <tr>
        <td>
           지하철 관리 시스템을 구현하는 데이터 구조를 익힐 수 있었으며 지하철 알고즘을 구현하는 방법을 배울 수 있었습니다. 또한 일반적인 dijkstra 알고리즘을 쓴 것이 아니라 호선, 역이
           름, 다음역, 이전역, 환승여부를 하나의 Station이라는 클래스 안에 멤버변수로 만들어서 저희만의 최단 경로를 구했던 점에서 뜻 깊었던 프로젝트였습니다. 또한, 다시 한번 더 JDBC로
           CRUD를 구현하는데 복습을 할 수 있었습니다.
        </td>
    </tr>
</table>
